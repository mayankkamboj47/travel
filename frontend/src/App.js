...
function App() {
  const hotelData= {"rooms": {"guests": 16.0, "bedrooms": 5.0, "beds": 5.0, "bathrooms": 6.5}, 
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        reviews={hotelData.reviews} location= {hotelData.location} images= {hotelData.images} description={hotelData.description} />} />
      </Routes>
    </BrowserRouter>
  );
}
